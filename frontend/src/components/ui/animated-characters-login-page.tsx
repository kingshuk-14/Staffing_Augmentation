    ...
    try {
      if (!isOtpStep) {
        ...
        if (response.ok) {
          ...
          else if (data.user.role === 'alphaxine') navigate('/alphaxine');
          else navigate('/recruiter'); // default
        } else {
        ...
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {!isOtpStep ? (
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onBlur={() => setIsTyping(false)}
                  required
                  className="h-12 bg-background border-border/60 focus:border-primary text-center tracking-widest text-lg"
                />
                <p className="text-xs text-muted-foreground mt-2">
                  An OTP has been sent to {email}. It will expire in 5 minutes.
                </p>
              </div>
            )}
            ...
            <Button 
              ...
              disabled={isLoading}
            >
              {isLoading ? (!isOtpStep ? "Sending OTP..." : "Signing in...") : (!isOtpStep ? "Send OTP" : "Log in")}
            </Button>
          </form>
          ...
          <div className="text-center text-sm text-muted-foreground mt-8">
            ...
            <Link to="/signup" className="text-foreground font-medium hover:underline text-primary">
              Sign Up
            </Link>
          </div>
        </div>
